...
// Settings contains metadata shared by every Dapr component backed by Swytch.
...
// ParseMetadata converts Dapr component metadata into an engine runtime
// configuration.
func ParseMetadata(meta metadata.Base) (beacon.RuntimeConfig, error) {
	settings := Settings{
